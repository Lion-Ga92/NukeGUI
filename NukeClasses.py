    ...
    def GUI2_outlay(self, window2):
        ...
        def arm_seq():
            ...
            if code_1_try == code_1:
                ...
                self.window2.after(1000, dialogue_prearm2)
        ...
        def pre_arm_seq2():
            ...
            self.Text_main2.insert(tk.END, "\n PLEASE ENTER DIGIT...")
            self.window2.after(1000, arm_seq2a)
        ...
        def arm_seq2a():
            ...
            if code_2_try == code_2:
                ...
                self.Text_main2.insert(tk.END, "\n Please enter another number digit: ")
                self.ENT_fordata2.delete(0)
                self.window2.after(1000, pull_for_aseq2a)
        ...
        def dialogue_prearm4():
            self.Text_main2.insert(tk.END, "CONGRATULATIONS USER44444444444YOUR HAVE GUESSED THE LAST CODE DIGIT CORRECTLY")
        ...
        def pre_arm_5dia():
            self.Text_main2.insert(tk.END, "\n ===============")
            self.window2.after(1000, pre_arm_6dia)

        def pre_arm_6dia():
            self.Text_main2.insert(tk.END, "\n ===============")
            self.window2.after(1000, pre_arm_7dia)
        ...
        def arm_seq3b():
            ...
            if code_3a_try== code_3a:
                ...
                self.Text_main2.insert(tk.END, "\n Please enter another number digit: ")
                self.ENT_fordata2.delete(0)
                self.window4.after(1000, pull_for_aseq2b)
        ...
        self.Bttn_bypass2 = tk.Button(master=self.frame_e2, text="Cont", fg="red", bg="yellow")
